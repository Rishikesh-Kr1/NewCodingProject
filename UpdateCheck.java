...
public class UpdateCheck extends JFrame implements ActionListener {
    JTextField tfroom, tfpaid, tfname, tfcheckin, tfpending;
    Choice ccustomer;
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==check){
            ...
            try{
                Conn c=new Conn();
                c.s.executeUpdate("update customer set roomnumber= '"+room+"', name= '"+name+"', checkintime= '"+checkin+"',deposit= '"+deposit+"' where number='"+number +"'");
    ...
    public static void main(String[] args) {
       UpdateCheck obj= new UpdateCheck();
    }
}
