...
public class AddDriver extends JFrame implements ActionListener{
    ...
    JComboBox availablecombo, gendercombo, typecombo ;    
        ...
        JLabel heading = new JLabel("AddDriver");
        heading.setFont(new Font ("Tahama",Font.BOLD , 18));
        heading.setBounds(150, 10, 200, 20);
        add(heading);
        
        JLabel lblname = new JLabel("Name");
        lblname.setFont(new Font ("Tahama",Font.PLAIN , 16));
        ...
        lblage.setFont(new Font ("Tahama",Font.PLAIN , 16));
        ...
        lblclean.setFont(new Font ("Tahama",Font.PLAIN , 16));
        ...
        lblprice.setFont(new Font ("Tahama",Font.PLAIN , 16));
        ...
        lbltype.setFont(new Font ("Tahama",Font.PLAIN , 16));
        ...
        lblavailable.setFont(new Font ("Tahama",Font.PLAIN , 16));
        ...
        lbllocation.setFont(new Font ("Tahama",Font.PLAIN , 16));
        ...
        if(ae.getSource()==add){
           ...
           try{
            ...
            String str = "insert into driver values ('"+ name+"','"+age+"','"+gender+
                    "','"+company+"','"+brand+"','"+availability+"','"+location+"')"; 
